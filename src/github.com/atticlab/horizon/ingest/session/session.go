...
import (
	...
	"github.com/atticlab/horizon/admin"
	"github.com/atticlab/horizon/db2/history"
	"github.com/atticlab/horizon/db2/history/details"
	"github.com/atticlab/horizon/ingest/participants"
	"github.com/atticlab/horizon/ingest/session/helpers"
...
func (is *Session) ingestLedger() error {
	...
	if is.Cursor.LedgerSequence() == 1 {
		...
		general := history.NewAccount(2, viper.GetString("general-agent-key"), xdr.AccountTypeAccountGeneralAgent)
		err = is.Ingestion.Account(general, false, nil, nil)
		if err != nil {
			return err
		}
